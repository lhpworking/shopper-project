                                        ...
                                        <div className="col-12 col-md-6">
                                            ...
                                            <div className="card">
                                                ...
                                                <div className="mb-4" data-flickity="{&quot;draggable&quot;: false, &quot;fade&quot;: true}" id="productSlider">
                                                    {/* Item */ }
                                                    {
                                                        <a href={ product?.thumbnail_url } data-fancybox key={ i }>
                                                            <img src={ product?.thumbnail_url } alt={ product?.name } className="card-img-top" />
                                                        </a>
                                                    }
                                        ...
                                        <div className="col-12 col-md-6 pl-lg-10">
                                            ...
                                            <div className="row mb-1">
                                                ...
                                                <div className="col-auto">
                                                    {/* Rating */ }
                                                    <div className="rating font-size-xs text-dark" data-value={ product?.rating_average }>
                                            ...
                                            <div className="mb-7">
                                                ...
                                                <span className="font-size-sm ml-1">({ product?.stock_item.qty ? "In stock" : "Sold Out" })</span>
                                            </div>
                                            {/* Form */ }
                                            <form>
                                                <div className="form-group">
                                                    {/* Label */ }
                                                    {
                                                        product?.configurable_options?.map((item, i) => {
                                                            return (
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            <ul className="list list-unstyled mb-md-0 text-gray-500">
                                                                <li>
                                                                    <strong className="text-body">SKU</strong>: #{ product?.sku }
                                                                </li>
                                                                <li>
                                ...
                                <div className="col-12">
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-12 col-md text-md-center">
                                            {/* Rating */ }
                                            <div className="rating text-dark h6 mb-4 mb-md-0" data-value={ product?.rating_average }>
                                                <div className="rating-item">
                                                    <i className="fas fa-star" />
                                                </div>
                                                <div className="rating-item">
