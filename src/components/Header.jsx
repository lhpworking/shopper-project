                    ...
                    <div className="collapse navbar-collapse" id="topbarCollapse">
                        ...
                        <ul className="nav navbar-nav mr-8">
                            <li className="nav-item">
                                <Link className="nav-link" to={ SHOPPING_AND_RETURNS_PATH }>Shipping</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={ FAQ_PATH }>FAQ</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={ CONTACT_PATH }>Contact</Link>
                            </li>
                        </ul>
                        {/* Nav */ }
                                ...
                                <div className="dropdown-menu">
                                    <div className="card card-lg">
                                        <div className="card-body">
                                            <ul className="list-styled font-size-sm">
                                                <li className="list-styled-item">
                                                    <Link className="list-styled-link" to={ BLOG_PATH }>Blog</Link>
                                                </li>
                                                <li className="list-styled-item">
                                                    <a className="list-styled-link" to={ BLOG_POST_PATH }>Blog Post</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
