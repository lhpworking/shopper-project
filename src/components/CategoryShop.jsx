...
/* 
    ...
    2. Thêm category vào link để lấy ra sản phẩm cần thiết
    3. lấy sản phẩm ra đúng category
    4. Lưu category vào global state cho drawer search sử dụng chung
 */
...
export default function CategoryShop() {
    ...
    //         })
    //         .catch((err) => {
    //             console.log("Message category error:", err);
    //         })
    // }, [])
        ...
        <form className="mb-10 mb-md-0">
            <ul className="nav nav-vertical" id="filterNav">
                <li className="nav-item">
                    ...
                    {/* Collapse */ }
                    {
                        loadingCategory ? [...Array(10)].map((_, i) => <div key={ i }
                            style={ { marginBottom: 15 } }>
                            <Skeleton variant="rectangular" animation="wave" height={ 25 } />
                        </div>) : <div className="collapse show" id="categoryCollapse">
